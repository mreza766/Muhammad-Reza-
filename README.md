...
SLIDE 1: TITLE
================================
🔥 WEBSITE GRATIS 5 MENIT!
GitHub Pages Tutorial 2024
[Background: Gradient Blue-Purple]

SLIDE 2: SIAPKAN ALAT
================================
✅ Buka github.com
✅ Text Editor (VS Code)
...
================================
1. Klik "+" → New repo
2. Nama: portfolioku.github.io
3. Public ✓ Add README ✓
4. "Create repository"
[Animated arrows]

SLIDE 5: STEP 3 - UPLOAD
================================
1. Drag index.html ke repo
2. style.css (opsional)
3. gambar folder
4. "Commit changes"
[Drag-drop animation]
...
SLIDE 6: HTML CONTOH
================================
[index.html lengkap - copy dari bawah]
[Code highlight]

SLIDE 7: STEP 4 - PAGES
================================
1. Settings → Pages
...
SLIDE 9: WEBSITE LIVE!
================================
🌐 https://portfolioku.github.io
[Screenshot website cantik]

SLIDE 10: CUSTOM DOMAIN
================================
1. Beli domain Rp15rb/tahun
2. Settings → Custom domain
3. namasaya.com
4. Update DNS
[Domain registrar screenshot]

SLIDE 11: UPDATE WEBSITE
================================
1. Edit file di GitHub
2. Commit
3. Live dalam 1 menit!
[Before/After edit]

SLIDE 12: TROUBLESHOOT
================================
❌ Blank page?
→ Cek index.html di root
...
❌ Custom domain?
→ DNS 24 jam
[Error icons + solutions]

SLIDE 13: FITUR GRATIS
================================
✅ Unlimited bandwidth
✅ HTTPS otomatis
✅ CDN global
